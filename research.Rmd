...
<!-- body text about the general research of the lab (size set in style.css), the * * around a word make the word italicised-->
...
In the North American wildflower genus *Penstemon*, evolutionary transitions from bee to hummingbird pollination have occurred in an estimated 20+ lineages through changes to a complex of floral traits. Recent macroevolutionary analyses suggest that transitions to hummingbird pollination are associated with reduced diversification rates and that reverse transitions back to bee pollination are rare.
...
Hummingbird-adapted flowers have evolved a surprising number of times in separate bee-adapted lineages! This suggest the "hummingbird syndrome" strategy is often favored by selection and that these traits are genetically accessible to populations. Does standing variation or gene flow act as a source of adaptive alleles? In theory, adaptive introgression could bypass the waiting times for *de novo* mutations that generate adaptive change in complex traits. We are using whole genome resequencing and phylogenomic approaches to address whether hummingbird-adapted species share a history of introgression in genome regions that specify floral traits.
...
Evolutionary divergence in complex traits begins with local adaptation within populations. Determining the consequences of gene flow for population-level adaptation is a critical goal of evolutionary genetics. A major challenge is understanding how complex trait differences are maintained in recently diverged taxa. We are using population genomic approaches to examine the heritabiity of complex adaptations within populations and to determine how complex trait differences are maintained in the face of gene flow. We are focused on recently diverged pairs of sister species that differ in floral syndrome and show evidence of gene flow where species ranges overlap.

<table class="image" align="center">
<tr><td><img src="images/jonesii.jpg" align="center" height="225" style="padding: 10px"></td></tr>
</table>
...
<table class="image" align="left">
<tr><td><img src="images/modeling.jpg" align="left" height="225" style="padding: 10px"></td></tr>
</table>

Mating system has fundamental effects on the genetics of populations, including the fate of new beneficial alleles. Adaptation to a new pollinator may - in effect - alter patterns of pollen dispersal within and among populations, with effects on population isolation, local adaptation, and the occurrence of hybridization. We are studying the consequences of pollination system on mating events and population sturcture, which may have relevance for macroevolutionary dynamics.
