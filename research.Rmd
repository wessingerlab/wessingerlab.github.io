...
```{r, echo=FALSE, out.width="25%", out.extra='style="float:right; padding:10px; text-align: right"'}
...
Top picture: *P. neomexicanus*, bee syndrome. Bottom pucture: *P. barbatus*, hummingbird syndrome.
...
knitr::include_graphics("images/crownML.B1.asr.jpg")
```
