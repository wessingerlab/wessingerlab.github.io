...
```{r, echo=FALSE, out.width="40%", fig.cap="Josh says this picture of his puppy is a perfectly good representation of him.", out.extra='style="float:right; padding:10px"'}
